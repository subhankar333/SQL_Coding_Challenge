...
VALUES
 ...
 (4, 'Robbery', '2023-09-16', '144 Main St, LA', 'Armed robbery at a Bank', 'Open');
 ...
 (4, 4, 'Shyam Gupta', 'shyam@gupta.com', 'Minor injuries');
 ...
 (4, 4, 'Jane Smith', 'Armed and masked robber', 'Previous robbery convictions');
...
SELECT C.*, COALESCE(CASE WHEN S.Name = 'UnKnown' THEN 'No Suspect' ELSE S.Name END, S.Name) AS Suspect_Name
FROM Crime C LEFT JOIN Suspect S ON C.CrimeID = S.CrimeID

--- 20. List all suspects who have been involved in incidents with incident types 'Robbery' or 'Assault --- 
SELECT S.Name, C.IncidentType FROM Crime C JOIN Suspect S ON C.CrimeID = S.CrimeID WHERE C.IncidentType IN ('Robbery', 'Assault')